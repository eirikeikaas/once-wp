		...
		<div class="width-container">
				...
				<div class="clearfix"></div>
					...
					<?php while (have_posts()) : the_post(); 
						$col_count_progression = get_theme_mod('events_col_progression', '3');
						if($count >= 1+$col_count_progression) { $count = 1; }
						?>
					<div class="grid<?php echo get_theme_mod('events_col_progression', '3'); ?>column-progression <?php if($count == get_theme_mod('events_col_progression', '3')): echo ' lastcolumn-progression'; endif; ?>">
